...
const { openInspectExerciseResult, openEditExerciseResult, openDeleteExerciseResult } =
  useFitnessExerciseResultDialogs()
const { openChartExercise } = useFitnessExerciseDialogs()
